...
<table>
  ...
  <tbody>
    <tr>
      <td>infracost/actions/examples/terraform-cloud/code</td>
      <td align="right">$0</td>
...
```
Project: infracost/actions/examples/terraform-cloud/code
...
Monthly cost change for infracost/actions/examples/terraform-cloud/code
Amount:  +$743 ($0.00 → $743)
